<template>
  <header ref="headerDiv">
    <div class="header-inner">
      ...
      <ul class="gnb">
        <li
          v-for="(navTitle, index) in menuTitle"
          :key="navTitle.name"
          ref="navTitle"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35.362 35.362">
              ...
              >
                ...
                <path
                  ...
                  transform="translate(1559.553 -37.585)"
                  fill="#cacaca"
                />
              </g>
            </svg>
          ...
          <a href="https://github.com/kimJiHwan0618" target="_blank">
            ...
            >
              ...
              <path
                ...
                transform="translate(-38.036 -153.955)"
                fill="#161614"
              />
            </svg>
          </a>
