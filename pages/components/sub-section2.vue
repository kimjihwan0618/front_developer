  ...
  <section class="sub-section right">
    ...
    <div class="about-box">
      <ul>
        <li>
          <p>
            <img src="@/assets/images/career/logo1.png" alt="" />
          </p>
          <a href="#">
        ...
        <li>
          <p>
            <img src="@/assets/images/career/logo3.png" alt="" />
          </p>
          <a href="#">
        ...
        <li>
          <p>
            <img src="@/assets/images/career/logo2.png" alt="" />
          </p>
          <a href="#">
        ...
        <li>
          <p>
            <img src="@/assets/images/career/logo4.png" alt="" />
          </p>
          <a href="#">
